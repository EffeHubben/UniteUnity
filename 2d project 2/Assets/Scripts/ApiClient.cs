...
public class ApiClient : MonoBehaviour
{
    ...
    public async void Register()
    {
        ...
        if (wachtwoordValidatie)
        {
            ...
            var response = await PerformApiCall("https://avansict2199044.azurewebsites.net/account/register", "POST", jsonData);
            if (response == null)
            {
    ...
    {
        var response = await PerformApiCall("https://avansict2199044.azurewebsites.net/wereldbouwer/GetUserId", "GET", null, token);
