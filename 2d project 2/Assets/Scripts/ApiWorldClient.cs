...
public class ApiWorldClient : MonoBehaviour
{
    ...
    public async void RegisterWorld(WorldPrefabController controller)
    {
        ...
        if (SessionData.token != null)
        {
            ...
            var response = await PerformApiCall("https://avansict2199044.azurewebsites.net/wereldbouwer", "POST", jsonData, SessionData.token);
            Debug.Log(response);
        } else
        {
    ...
    {
        string url = $"https://avansict2199044.azurewebsites.net/wereldbouwer/getwereld/{ownerUserId}";
    ...
    public async Task LoadWorld()
    {
        if (SessionData.token != null)
        {
            ...
            string url = $"https://avansict2199044.azurewebsites.net/wereldbouwer/getwereld/{SessionData.ownerUserId}";
            var response = await PerformApiCall(url, "GET", null, SessionData.token);
    ...
    public async void DeleteSpecificWorld(string worldId)
    {
        if (SessionData.token != null)
        {
            ...
            string url = $"https://avansict2199044.azurewebsites.net/wereldbouwer/{worldId}";
    ...
    {
        string url = $"https://avansict2199044.azurewebsites.net/Object2D/environment/{worldId}";
