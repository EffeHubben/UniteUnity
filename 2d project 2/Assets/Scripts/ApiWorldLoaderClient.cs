...
public class ApiWorldLoaderClient : MonoBehaviour
{
    ...
    public async void SaveWorld()
    {
        ...
        string url = $"https://avansict2199044.azurewebsites.net/Object2D/{SessionData.worldId}";
        ...
        foreach (GameObject obj in instantiatedObjects)
        {
            ...
            if (prefabName != null) // Controleer of de prefab is gevonden
            {
                ...
                if (existingData != null)
                {
                    ...
                    string updateUrl = $"https://avansict2199044.azurewebsites.net/Object2D/UpdateObject2D";
                ...
                else
                {
                    ...
                    string postUrl = "https://avansict2199044.azurewebsites.net/Object2D";
    ...
    public async void DeleteWorldObjects()
    {
        ...
        string url = $"https://avansict2199044.azurewebsites.net/Object2D/environment/{SessionData.worldId}";
